...
{
    /// <inheritdoc />
    public partial class InitialCreate_backup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, DateTime.Now.AddDays(-3), "Bench Press" },
                    { 2, DateTime.Now.AddDays(-3), "Squat" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 95m, "mg/dL", 80, 120, DateTime.Now.AddDays(-1) },
                    { 2, 5.2m, "mmol/L", 75, 118, DateTime.Now.AddDays(-2) }
                });
